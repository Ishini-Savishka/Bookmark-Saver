...
$category_name = "recipe"; // Set the category name to "recipe"
...
if ($result->num_rows > 0) {
    ...
    echo "No results found for the category 'Recipes' associated with the logged-in user.";
}
$stmt->close();
?>
    ...
    <script>
        // Function to filter and display content based on type
